          ...
          <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
            <button
              ...
              style={{
                ...
                background: uploadMode === 'FILE' ? '#1a4731' : '#fff',
                color: uploadMode === 'FILE' ? '#fff' : '#3d5247',
                fontFamily: "'Lato',sans-serif",
                fontSize: 13,
                fontWeight: 700,
                cursor: 'pointer',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 20,
                border: '1px solid rgba(26,71,49,.2)',
                background: uploadMode === 'YOUTUBE' ? '#c0392b' : '#fff',
                color: uploadMode === 'YOUTUBE' ? '#fff' : '#3d5247',
                fontFamily: "'Lato',sans-serif",
                fontSize: 13,
                fontWeight: 700,
                cursor: 'pointer',
            ...
            <div style={{
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <input
                  ...
                  required
                />
                <p style={{ fontSize: 11, color: '#6b8070', marginTop: 5 }}>
        ...
        {TYPES.map(t => (
          <button
            ...
            style={{
              ...
              borderRadius: 20,
              border: '1px solid rgba(26,71,49,.2)',
              background: filter === t ? '#1a4731' : '#fff',
              color: filter === t ? '#fff' : '#3d5247',
              fontFamily: "'Lato',sans-serif",
              fontSize: 12,
              cursor: 'pointer',
              transition: 'all .2s'
